  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mx-auto max-w-4xl">
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 border-b-2 px-4 py-3 font-medium transition ${
                isActive ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-white'
              }`}
            >
      ...
      <motion.div
        ...
        className="rounded-lg bg-white backdrop-blur-md p-6 shadow"
      >
        {activeTab === 'preferences' && (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-semibold text-white">Preferencias del sistema</h3>
              <p className="text-sm text-slate-500">Estos ajustes se guardan en configuracion administrativa real.</p>
            </div>
            ...
            <section className="border-t border-gray-200 pt-6">
              ...
              {!mfaEnabled && !mfaSecret && (
                <button
                  ...
                  className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-slate-600 hover:bg-white disabled:opacity-50"
                >
              ...
              {!mfaEnabled && mfaSecret && (
                <div className="space-y-3 rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
                  ...
                  <input readOnly value={mfaSecret} className="w-full rounded border border-blue-500/30 bg-white backdrop-blur-md px-3 py-2 text-xs" />
                  <input readOnly value={mfaUri} className="w-full rounded border border-blue-500/30 bg-white backdrop-blur-md px-3 py-2 text-xs" />
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid max-w-xl grid-cols-1 gap-3">
                ...
                <p className="text-sm text-slate-500">Rol: {roleLabel}</p>
                <button
                  onClick={saveProfile}
