...
export default function DebtQuery({ tenantSlug, embedded = false }: Props) {
 ...
 <h2 className="text-2xl font-bold text-slate-800">Consulta tu Estado de Cuenta</h2>
 <p className="text-slate-500 text-sm mt-1">Ingresa tu número de documento para ver tus facturas pendientes</p>
 </div>
 ...
 <div>
 <p className="text-sm font-semibold text-slate-700 mb-2">📄 Facturas pendientes</p>
