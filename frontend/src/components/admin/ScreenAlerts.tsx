    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-400">Banners operativos para portal cliente por audiencia y severidad.</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
        <form onSubmit={createAlert} className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-4 shadow-sm">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-sm xl:col-span-2">
          ...
          <div className="divide-y divide-white/5">
            ...
            {!filteredItems.length && (
              <div className="px-4 py-8 text-center text-sm text-slate-400">Sin avisos para este filtro.</div>
            )}
          </div>
        </div>
      </div>
