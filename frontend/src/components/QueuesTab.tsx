               ...
               <div>
                 ...
                 <div className="mt-1 relative rounded-md shadow-sm">
                   <input
                     ...
                     className="focus:ring-blue-500 focus:border-blue-500 block w-full pr-12 sm:text-sm border-white/20 rounded-md"
                     placeholder="10"
                     required
                   />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  name="name"
                  id="create-name"
                  className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-white/20 rounded-md"
              ...
              <tr key={queue.id}>
                  ...
                  {editingCommentId === queue.id ? (
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="block w-full border-white/20 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        autoFocus
                      />
                      <button onClick={() => handleUpdateQueueComment(queue)} className="p-1 text-green-600 hover:bg-emerald-500/20 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                      </button>
                      <button onClick={() => setEditingCommentId(null)} className="p-1 text-red-600 hover:bg-rose-500/20 rounded-full">
                    ...
                    >
                      <span>{queue.comment || <span className="italic text-slate-500">Sin comentario</span>}</span>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    queue.disabled ? 'bg-rose-500/20 text-rose-300' : 'bg-emerald-500/20 text-emerald-300'
                  }`}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className={`flex items-center justify-center w-24 px-3 py-1 rounded-md text-xs font-semibold transition-colors ${
                        queue.disabled
                          ...
                          : 'bg-rose-500/20 text-rose-400 hover:bg-red-200'
                      } disabled:opacity-50`}
                    >
                    ...
                    <button
                      ...
                      className="p-2 text-red-500 hover:bg-rose-500/20 rounded-md" title="Eliminar Cola">
