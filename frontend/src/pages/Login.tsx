...
const Login: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (window.google && clientId) {
      ...
      const parent = document.getElementById('google-button-parent')
      if (parent) {
      ...
      <div className="flex-1 flex flex-col justify-center p-8 sm:p-12 lg:p-24 bg-white relative">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            ...
            <div id="google-button-parent" className="w-full flex justify-center min-h-[50px]">
              {/* Official Google Button will be rendered here */}
            </div>
          </form>
