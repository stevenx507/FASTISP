...
@client_bp.route('/admin/clients/<int:client_id>/change_plan', methods=['POST'])
@jwt_required()
...
@client_bp.route('/client/portal', methods=['GET'])
@jwt_required()
...
@client_bp.route('/client/invoices', methods=['GET'])
@jwt_required()
def client_invoices():
    current_user_id = _current_user_id()
    if current_user_id is None:
...
@client_bp.route('/client/tickets', methods=['GET'])
@jwt_required()
...
@client_bp.route('/client/tickets', methods=['POST'])
@jwt_required()
...
def client_tickets_create():
    ...
    ticket = Ticket(
        ...
        status='open',
        sla_due_at=datetime.now(timezone.utc) + timedelta(hours=24 if priority != 'urgent' else 4),
    )
    from app import db
...
@client_bp.route('/client/diagnostics/run', methods=['POST'])
@jwt_required()
...
@client_bp.route('/client/notifications/preferences', methods=['GET', 'POST'])
@jwt_required()
...
@client_bp.route('/client/wifi-settings', methods=['GET', 'POST'])
@jwt_required()
...
@client_bp.route('/clients/map-data', methods=['GET'])
@staff_required()
...
@client_bp.route('/clients/<int:client_id>/reboot-cpe', methods=['POST'])
@jwt_required()
...
@client_bp.route('/clients/<int:client_id>/history', methods=['GET'])
@admin_required()
...
@client_bp.route('/clients/usage-history', methods=['GET'])
@jwt_required()
...
@client_bp.route('/client/support/ai-chat', methods=['POST'])
@jwt_required()
...
@client_bp.route('/client/invoices/<int:invoice_id>/pdf', methods=['GET'])
@jwt_required()
...
@client_bp.route('/admin/clients', methods=['GET'])
@admin_required()
...
@client_bp.route('/admin/clients/export', methods=['GET'])
@admin_required()
...
@client_bp.route('/admin/clients', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/bulk-create', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/bulk-update', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/<int:client_id>/portal-access', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/bulk-action', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/<int:client_id>/suspend', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/<int:client_id>/activate', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/<int:client_id>/speed', methods=['POST'])
@admin_required()
...
@client_bp.route('/admin/clients/<int:client_id>/scripts', methods=['GET'])
@admin_required()
